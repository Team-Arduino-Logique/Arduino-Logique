...
wireTest = [
    (drawWire, 1, {"color": (255, 0, 0, 255), "mode": AUTO, "coords": [(1, 3, 3, 2)], "matrix": matrix1260pts}),
...
railAlimPlus = [
    (drawBlank, 1),
    (drawChar, 1, {"color": "#ff0000", "text": "+", "deltaY": -0.6, "scaleChar": 2}),
    (drawredRail, 60),
    (drawBlank, 1),
    (drawHalfBlank, 1),
    (drawChar, 1, {"color": "#ff0000", "text": "+", "deltaY": -0.6, "scaleChar": 2}),
...
bandeDistribution = [(line_distribution, 5, {"direction": VERTICAL})]
numerotation = [
    (drawBlank, 1),
    (drawNumIter, 1, {"beginNum": 1, "endNum": 63, "direction": HORIZONTAL, "deltaY": -1.5}),
]
...
board830pts = [
    (setXYOrigin, 1, {"id_origin": "bboard830"}),
    (drawBoard, 1),
    (drawHalfBlank, 1, {"direction": HORIZONTAL}),
    (drawHalfBlank, 1, {"direction": VERTICAL}),
    (bandeAlim, 1, {"direction": VERTICAL}),
    (numerotation, 1, {"direction": VERTICAL}),
    (goXY, 1, {"line": 5.5, "column": 0.5, "id_origin": "bboard830"}),
    (drawCharIter, 1, {"beginChar": "f", "numChars": 5, "anchor": "center", "deltaY": 0.7}),
    (bandeDistribution, 1, {"direction": VERTICAL}),
    (goXY, 1, {"line": 5.5, "column": 64.5, "id_origin": "bboard830"}),
    (drawHalfBlank, 1),
    (drawCharIter, 1, {"beginChar": "f", "numChars": 5, "direction": VERTICAL, "deltaY": 0.7}),
    (goXY, 1, {"line": 12.5, "column": 0.5, "id_origin": "bboard830"}),
    (drawCharIter, 1, {"beginChar": "a", "numChars": 5, "deltaY": 0.7}),
    (bandeDistribution, 1, {"direction": VERTICAL}),
    (goXY, 1, {"line": 12.5, "column": 64.5, "id_origin": "bboard830"}),
    (drawHalfBlank, 1),
    (drawCharIter, 1, {"beginChar": "a", "numChars": 5, "direction": VERTICAL, "deltaY": 0.7}),
    (goXY, 1, {"line": 18.8, "column": 0.5, "id_origin": "bboard830"}),
    (numerotation, 1, {"direction": VERTICAL}),
    (goXY, 1, {"line": 18.5, "column": 0.5, "id_origin": "bboard830"}),
    (bandeAlim, 1, {"direction": VERTICAL}),
...
circuitTest = [
    (setXYOrigin, 1, {"id_origin": "circTest"}),
    (board1260pts, 1),
    (goXY, 1, {"line": 10.1, "column": 1.4, "id_origin": "circTest"}),
    ...
    (goXY, 1, {"line": 0, "column": 0, "id_origin": "circTest"}),
    (wireTest, 1),
]
